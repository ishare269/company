...
public class MailSendInfo {
	...
	private static MailSendInfo mailInfo;

	public static Map<String, Integer> getInstance(String subject,
			String content, String tos) {
		if (null == mailInfo) {
			mailInfo = new MailSendInfo();
		}
		...
		String[] toAddress = tos.replace("；", ";").split(";");
		for (String to : toAddress) {
			mailInfo.setToAddres(to);
