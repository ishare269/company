package com.stone.company.util.mail;
...
/**
 * <p>Class Name: SimpleMailSender</p>
 * <p>Description: 邮件发送(带附件)</p>
 * <p>Sample: 使用时需要加入mail.jar文件，因为JDK中只有mail的接口，没有实现类</p>
 * <p>Author: 石涛</p>
 * <p>Date: 2014-11-27</p>
...
//		mailInfo.attachFile("C:/Users/Administrator/Desktop/JVM.jpg");
		...
		mailInfo.setUserName("476896460@qq.com");
		mailInfo.setPassword("st0stone_9759");
		mailInfo.setFromAddress("476896460@qq.com");
		mailInfo.setToAddres("495631701@qq.com");
		mailInfo.setSubject("发送邮件");
		mailInfo.setContent("这是一封测试邮件，请不要做任何回复<a href=\"http://www.baidu.com\" target=\"_blank\">百度</a>");
